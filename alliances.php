                  ...
                  <div class="hero-content">
                    <div class="container--content">
                      <div class="row">
                        <div class="col-md-12">
                          <hgroup>
                            <h1 class="title lg-margin-bottom">STRATEGIC ALLIANCES</h1>
                          </hgroup>
                        </div>
                      </div>
                    </div>
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-md-6 container--content">
                    ...
                    <p><a href="concierge.php">Sophisticated Planning Strategies Team</a></p>
                    <p><a href="investment.php">Investment Team</a></p>
                  </div>
                </div>
              </div>
            </div>
